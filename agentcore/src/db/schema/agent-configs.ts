...
export const agentTypeEnum = pgEnum('agent_type', [
  'discovery', 'enrichment', 'document', 'scoring', 'outreach', 'reply', 'action', 'email-listen', 'email-send', 'mailbox', 'reddit-monitor', 'strategy', 'strategist', 'company-finder', 'candidate-finder', 'linkedin',
]);
